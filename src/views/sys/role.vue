<template>
  <div class="app-container">
    ...
    <el-table  v-loading="listLoading" :data="list" size="small" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      <el-table-column align="center" label="角色名称" prop="name" width="250px" sortable/>
    ...
    updateData () {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          this.sendForm.name = this.dataForm.name
          this.sendForm.description = this.dataForm.description
          updateRole(this.sendForm).then(() => {
